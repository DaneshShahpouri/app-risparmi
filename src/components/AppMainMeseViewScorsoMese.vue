...
export default {
  name: 'AppMainMeseViewScorsoMese',
  ...
  methods: {
    createDoughnut() {
      ...
      this.entrate = this.store.data.user[this.anno - 2000][this.scorsoMese].s.tot;
      this.bollette = this.store.data.user[this.anno - 2000][this.scorsoMese].sb.tot;
      this.affitto = this.store.data.user[this.anno - 2000][this.scorsoMese].sc.tot;
      this.alimenti = this.store.data.user[this.anno - 2000][this.scorsoMese].ss.tot;
      this.altro = this.store.data.user[this.anno - 2000][this.scorsoMese].sas.tot;
    ...
    setSpesaMaggioreCategoria() {
      ...
      for (const key in this.store.data.user[this.anno - 2000][this.scorsoMese]) {


        for (const key2 in this.store.data.user[this.anno - 2000][this.scorsoMese][key].mag.pre) {

          const valoreMag = this.store.data.user[this.anno - 2000][this.scorsoMese][key].mag.pre[key2];
